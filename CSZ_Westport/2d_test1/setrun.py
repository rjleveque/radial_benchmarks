...
#------------------------------
    ...
    clawdata.lower[0] = 60.0          # xlower
    clawdata.upper[0] = 80.0          # xupper
    clawdata.lower[1] = 50.0          # ylower
    clawdata.upper[1] = 65.0          # yupper

    # Number of grid cells for 5' grid:
    clawdata.num_cells[0] = 20*12      # mx
    clawdata.num_cells[1] = 15*12      # my
    ...
    if clawdata.output_style==1:
        ...
        clawdata.output_times =  [0., 2.,600,1200,1800] \
                                + list(np.arange(42,61,1)*60)
    ...
    regions.append([1, 1,  0., 1e9, 60, 80, 50, 65])
    regions.append([3, 3,  0., 1e9, 65, 75, 54, 60])  # dtopo region
    regions.append([1, 4,  0., 1e9, 71, 72, 57.5, 58.5])  # 3" region
    regions.append([6, 6,  2200., 1e9, 71.32, 71.42, 58.06, 58.10]) # 1/3" region
    ...
    80.05195685785145, 80.08575796844195, 61.71789436082927, 61.72954809264638
    fg.x1 = 80.051956
    fg.x2 = 80.085757
    fg.y1 = 61.717894
    fg.y2 = 61.729548
    ...
    fg.tstart_max = 600.  # just before wave arrives
