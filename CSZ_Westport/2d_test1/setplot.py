...
#--------------------------
    ...
    def fixup(current_data):
        ...
        pylab.gca().set_aspect(1./pylab.cos(60*pylab.pi/180.))
    ...
    plotitem.colorbar_kwargs = {'shrink':0.7, 'extend':'both'}
    ...
    #-----------------------------------------
    # Figure for zoom on shelf
    #-----------------------------------------
    plotfigure = plotdata.new_plotfigure(name='Shelf', figno=6)
    # Set up for axes in this figure:
    ...
    #-----------------------------------------
    # Figure for zoom on shore
    #-----------------------------------------
    plotfigure = plotdata.new_plotfigure(name='Shore', figno=7)
    # Set up for axes in this figure:
    plotaxes = plotfigure.new_plotaxes('zoom')
    plotaxes.title = 'Surface at time h:m:s'
    plotaxes.aspect_latitude = 60
    ...
    plotaxes.xlimits = [71.3, 71.42]
    plotaxes.ylimits = [58.05, 58.10]
